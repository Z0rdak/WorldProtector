...
public class CommandDimension {
    ...
    public static final LiteralArgumentBuilder<CommandSource> DIMENSION_COMMANDS = register();
    ...
    /*
    /wp dim flag add <flag>
    /wp dim flag <flag>
    /wp dim protector add <player>
    /wp dim protector remove <player>
    /wp dim is-whitelist <true|false>
     */
